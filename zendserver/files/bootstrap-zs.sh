...
/usr/local/zend/bin/zs-manage bootstrap-single-server -w 10 -p $ZEND_ADMIN_PASS -o $ZEND_LICENSE_ORDER -l $ZEND_LICENSE_SERIAL -a true -r false > /tmp/zs-bootstrap-output
