...
zendserver_repo:
  pkgrepo.managed:
    ...
    - name: deb http://repos-source.zend.com/zend-server/{{zend_version}}/deb_apache2.4 server non-free
    {% else %}
    - name: deb http://repos-source.zend.com/zend-server/{{zend_version}}/deb_ssl1.0 server non-free
    {% endif %}
